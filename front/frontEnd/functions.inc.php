...
function sentInvoice($conn,$order_id){
	$res=mysqli_query($conn,"select distinct(order_detail.id) ,order_detail.*,product.name,product.image from order_detail,product ,product_order where order_detail.order_id='$order_id' and order_detail.product_id=product.id");

	$user_order=mysqli_fetch_assoc(mysqli_query($conn,"select product_order.*, test.name,test.email  from product_order,test where test.id=product_order.user_id and product_order.id='$order_id'"));

	$coupon_details=mysqli_fetch_assoc(mysqli_query($conn,"select coupon_value from product_order where id='$order_id'"));
					  ...
					  <tr>
						<td class="content-cell">
						  <div class="f-fallback">
							...
							<p>Thanks for visiting our Stores. This is an invoice for your recent purchase.</p>
								...
								<td class="attributes_content">
								  <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
									<tr>
                                      ...
                                      if($user_order['payment_type']=='payu'){
                                        $html.='<span class="f-fallback">
							...
							<table class="purchase" width="100%" cellpadding="0" cellspacing="0">
							  <tr>
								...
								<td>
								  <h3 class="align-right" style="margin-right:3px;">'.$user_order['added_on'].'.</h3>
								</td>
							  </tr>
                              <tr>
					...
					<table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
					  <tr>
						<td class="content-cell" align="center">
						  <p class="f-fallback sub align-center">&copy;'.$date.' All rights reserved.</p>
						  <p class="f-fallback sub align-center">
							Jaiswal Cycle Store
							<br>Main road Kolhabi.
							<br>Bara,Nepal
						  </p>
						</td>
					  </tr>
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="manishjaiswal152207@gmail.com";
	$mail->Password="manish152207";
	$mail->SetFrom("manishjaiswal152207@gmail.com");
