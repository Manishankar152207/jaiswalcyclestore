...
if(isset($_SESSION['User_Login'])){
	$res=mysqli_fetch_assoc(mysqli_query($conn,"select name from test where id='$uid'"));
}
?>
								...
								<form id="login-form" method="post">
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="name" id="name" placeholder="Your Name*" style="width:100%" value="<?php echo $res['name']?>">
										</div>
